                        ...
                        : error ? (<MessageBox variant="danger">{error}</MessageBox>)
                            : (<>
                                ...
                                <div>
                                    ...
                                    <input id="confirmPassword" type="password" placeholder="Enter password confirmation" ></input>
                                </div>
                                <div>
                                    <label />
                                    <button className="primaty" type="submit" >Update</button>
                                </div>
                            </>)
                }
            </form>
